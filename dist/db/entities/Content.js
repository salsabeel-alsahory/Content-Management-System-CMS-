...
let Content = (() => {
    ...
    (() => {
        ...
        _category_decorators = [(0, typeorm_1.ManyToOne)(type => Category_1.Category, category => category.contents)];
        _tags_decorators = [(0, typeorm_1.ManyToMany)(type => Tag_1.Tag), (0, typeorm_1.JoinTable)()];
        ...
        __esDecorate(null, null, _category_decorators, { kind: "field", name: "category", static: false, private: false, access: { has: obj => "category" in obj, get: obj => obj.category, set: (obj, value) => { obj.category = value; } }, metadata: _metadata }, _category_initializers, _instanceExtraInitializers);
        __esDecorate(null, null, _tags_decorators, { kind: "field", name: "tags", static: false, private: false, access: { has: obj => "tags" in obj, get: obj => obj.tags, set: (obj, value) => { obj.tags = value; } }, metadata: _metadata }, _tags_initializers, _instanceExtraInitializers);
